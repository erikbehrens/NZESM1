!  SVN:$Id: ice_therm_vertical.F90 825 2014-08-29 15:37:09Z eclare $
!=========================================================================
!
...
!          C. M. Bitz, UW
      ...
      real (kind=dbl_kind), dimension (nx_block,ny_block), intent(out):: &
         ...
         evapn_ice, & ! evaporative water flux over ice only (kg/m^2/s)
         evapn_snow   ! evaporative water flux over snow only (kg/m^2/s)
