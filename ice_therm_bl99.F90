!  SVN:$Id: ice_therm_bl99.F90 710 2013-09-03 22:46:53Z eclare $
!=========================================================================
!
...
! 2012: Split from ice_therm_vertical.F90
      ...
      use ice_therm_shared, only: calculate_ki_from_Tin, &
         conduct, calc_Tsfc, ferrmax, l_brine, hfrazilmin, kimin, betak
...
!         C. M. Bitz, UW
	 ...
	 enew_icells(ij) = c0
      ...
      call effect_conductivity (nx_block, ny_block,         &
                        	l_snow,   icells,           &
                        	indxi,    indxj,    indxij, &
                        	hilyr,    hslyr,            &
                        	zTin,     kh,       zSin)
...
!         C. M. Bitz, UW
      ...
      subroutine effect_conductivity (nx_block, ny_block,         &
                        	      l_snow,   icells,           &
                        	      indxi,    indxj,    indxij, &
                        	      hilyr,    hslyr,            &
                        	      zTin,     kh,       zSin)
...
!ocl novrec      !Fujitsu
      ...
      end subroutine effect_conductivity
