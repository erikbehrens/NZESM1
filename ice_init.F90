!  SVN:$Id: ice_init.F90 843 2014-10-02 19:54:30Z eclare $
!=======================================================================
...
! author Elizabeth C. Hunke, LANL
      ...
      use ice_restart_shared, only: &
          ...
          runid, runtype, use_restart_time, restart_format, lcdf64, lnetcdf4
      ...
      lnetcdf4     = .false. ! netcdf4 format for netCDF
      ...
      albpondv  = 0.27_dbl_kind   ! melt pond albedo, visible
      albpondi  = 0.07_dbl_kind   ! melt pond albedo, near IR
      ...
      if (trim(shortwave) /= 'dEdd' .and. tr_pond .and.(.not.tr_pond_topo) &
                                                     .and. calc_tsfc) then
         if (my_task == master_task) then
      ...
      call broadcast_scalar(lnetcdf4,           master_task)
      ...
      call broadcast_scalar(albpondv,           master_task)
      call broadcast_scalar(albpondi,           master_task)
      ...
      if (my_task == master_task) then
         ...
         write(nu_diag,1000) ' albpondv                  = ', albpondv
         write(nu_diag,1000) ' albpondi                  = ', albpondi
